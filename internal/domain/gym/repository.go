...
type Repository interface {
	...
	// GymEntry operations
	ListGymEntries(ctx context.Context, familyID string, filter ListFilter) ([]GymEntry, int64, error)
	GetGymEntryByID(ctx context.Context, familyID, entryID string) (*GymEntry, error)
	CreateGymEntry(ctx context.Context, entry *GymEntry) error
	UpdateGymEntry(ctx context.Context, entry *GymEntry) error
	DeleteGymEntry(ctx context.Context, familyID, entryID string) (bool, error)

	// Workout operations
	ListWorkouts(ctx context.Context, familyID string, filter ListFilter) ([]Workout, int64, error)
	GetWorkoutByID(ctx context.Context, familyID, workoutID string) (*Workout, error)
	CreateWorkout(ctx context.Context, workout *Workout) error
	UpdateWorkout(ctx context.Context, workout *Workout) error
	DeleteWorkout(ctx context.Context, familyID, workoutID string) (bool, error)
	...
	ListTemplates(ctx context.Context, familyID string) ([]WorkoutTemplate, error)
	GetTemplateByID(ctx context.Context, familyID, templateID string) (*WorkoutTemplate, error)
	...
	DeleteTemplate(ctx context.Context, familyID, templateID string) (bool, error)
	...
	// Exercise list
	ListExercises(ctx context.Context, familyID string) ([]string, error)
}
